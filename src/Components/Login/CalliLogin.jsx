        ...
        <div className={classes.root}>
            <StylesProvider injectFirst>
                <FormControl className={clsx(classes.textField)} variant="outlined">
                    ...
                    <OutlinedInput className={classes.greenButton}
...
class CalliLogin extends Component {
    ...
    StyledButton = () => {
        ...
        return <Button className={myStyle.root} size="medium" variant="contained" color="primary">Login</Button>
    ...
    StyledButton2 = () => {
        ...
        return <Button className={myStyle.root} size="medium" margin="normal" variant="outlined" color="primary">Create Account</Button>
                        ...
                        <div className="form-section" style={{ width: "45%" }} >
                            ...
                            <TextField
                                ...
                                InputProps={{
                                    startAdornment: (
                                        <InputAdornment position="start">
                                            <MailOutlineIcon size="small" style={this.iconColor} />
                                        </InputAdornment>
                                    ),
                                }}
                            />
                            ...
                            <div><p className="welcomMsg" style={{ color: '#382f34' }}>Or you can join us with</p></div>
    ...
    <Tilt className="Tilt " options={{ max: 25 }} styles={{ height: 50, width: 150 }}>
